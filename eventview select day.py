#updated version of testview4.py with the following changes: editable upcoming events via new window, where you can change the event name, date, description, start and end time. Also added a delete button to delete events from the day view.
